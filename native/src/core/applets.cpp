...
constexpr const char *applets[] = { "su", "resetprop", "magiskhide", "zygisk", nullptr };
static main_fun applet_mains[] = { su_client_main, resetprop_main, denylist_cli, zygisk_main, nullptr };
